...
-- It returns an infinite list of complex numbers representing the iterations of the Mandelbrot function starting from 0. Each element in the list is computed by squaring the previous element and adding c.
